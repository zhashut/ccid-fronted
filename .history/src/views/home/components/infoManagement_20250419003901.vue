      ...
      <a-table :columns="columns" :data-source="data">
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.key === 'type'">
            <a-tag v-if="record.content === '专利'" color="blue">{{
              record.content
            }}</a-tag>
            <a-tag v-else-if="record.content === '软件著作权'" color="orange">{{
              record.content
            }}</a-tag>
            <a-tag v-else-if="record.content === '专利'" color="green">{{
              record.content
            }}</a-tag>
          </template>

          <template v-if="column.key === 'state'">
            <a-tag v-if="record.content === '已完成'" color="blue">{{
              record.content
            }}</a-tag>
          </template>
